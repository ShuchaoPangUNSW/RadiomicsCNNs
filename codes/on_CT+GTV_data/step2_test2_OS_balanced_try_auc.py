...
def test_generator(batch_size2=106):
    ...
    image_generator = image_datagen.flow_from_directory(
        '/home/shuchao/codes/unsw_ingham_Shuchao/balanced_data_ImagesAndMasks/OS/TEST/images',
        class_mode='binary',
    ...
    mask_generator = mask_datagen.flow_from_directory(
        '/home/shuchao/codes/unsw_ingham_Shuchao/balanced_data_ImagesAndMasks/OS/TEST/masks',
        class_mode='binary',
        color_mode='grayscale',
        target_size=(512,512),
        batch_size=batch_size2,
...
def main():
    ...
    imagedir = rootdir + "OS/" #rootdir + "IMAGES_DM_CENTER/"
    outcometype = 'OS/'
    #logtitle = "2ndRun_2020"
    logtitle = "step2_train2_OS_balanced_try_3_val_auc_bceER"#'released_ours_4_newNet_2_newAUC_united_2_DM_balanced'
    size = 512
    print(logtitle)
